...
RSpec.describe WikidataDiffAnalyzer do
  describe '.analyze' do
    ...
    # testing with the first revisions (with parent id being zero)
    it 'returns the correct result for a revision array' do
      revision_ids = [1016232717]

      analyzed_revisions = WikidataDiffAnalyzer.analyze(revision_ids)

      expected_result = {:diffs_analyzed_count=>1, :diffs_not_analyzed=>[], :diffs=>{1016232717=>{:added_claims=>0, :removed_claims=>0, :changed_claims=>0, :added_references=>0, :removed_references=>0, :changed_references=>0, :added_qualifiers=>0, :removed_qualifiers=>0, :changed_qualifiers=>0, :added_aliases=>0, :removed_aliases=>0, :changed_aliases=>0, :added_labels=>1, :removed_labels=>0, :changed_labels=>0, :added_descriptions=>0, :removed_descriptions=>0, :changed_descriptions=>0, :added_sitelinks=>0, :removed_sitelinks=>0, :changed_sitelinks=>0, :merge_to=>0, :merge_from=>0, :redirect=>0, :undo=>0, :restore=>0, :clear_item=>0}}, :total=>{:claims_added=>0, :claims_removed=>0, :claims_changed=>0, :references_added=>0, :references_removed=>0, :references_changed=>0, :qualifiers_added=>0, :qualifiers_removed=>0, :qualifiers_changed=>0, :aliases_added=>0, :aliases_removed=>0, :aliases_changed=>0, :labels_added=>1, :labels_removed=>0, :labels_changed=>0, :descriptions_added=>0, :descriptions_removed=>0, :descriptions_changed=>0, :sitelinks_added=>0, :sitelinks_removed=>0, :sitelinks_changed=>0, :merge_to=>0, :merge_from=>0, :redirect=>0, :undo=>0, :restore=>0, :clear_item=>0}}
      expect(analyzed_revisions).to eq(expected_result)
    end
  end
end
