...
RSpec.describe '.isolate_claim_differences' do
  ...
  it 'returns the correct added claims' do
    result = LargeBatchesAnalyzer.handle_large_batches([1_895_908_644], 50)
    current_content = result[1_895_908_644][:current_content]
    parent_content = result[1_895_908_644][:parent_content]

    expected_result = {
      added_claims: [{ key: 'P2196', index: 1 }, { key: 'P6589', index: 0 },
                     { key: 'P6589', index: 1 }],
      removed_claims: [],
      changed_claims: [],
      added_references: [{ claim_key: 'P2196', claim_index: 1, reference_index: 0 },
                         { claim_key: 'P6589', claim_index: 0, reference_index: 0 }, { claim_key: 'P6589', claim_index: 1, reference_index: 0 }],
      removed_references: [],
      changed_references: [],
      added_qualifiers: [{ claim_key: 'P2196', claim_index: 1, qualifier_key: 'P585', qualifier_index: 0 },
                         { claim_key: 'P6589', claim_index: 0, qualifier_key: 'P585', qualifier_index: 0 }, { claim_key: 'P6589', claim_index: 1, qualifier_key: 'P585', qualifier_index: 0 }],
      removed_qualifiers: [],
      changed_qualifiers: []
    }
  ...
  it 'returns the correct removed claims' do
    ...
    result = LargeBatchesAnalyzer.handle_large_batches([1_902_995_129], 50)
    current_content = result[1_902_995_129][:current_content]
    parent_content = result[1_902_995_129][:parent_content]
    ...
    expected_result = {
      ...
      changed_references: [],
      added_qualifiers: [],
      removed_qualifiers: [{ claim_key: 'P2196', claim_index: 1, qualifier_key: 'P585',
                             qualifier_index: 0 }],
      changed_qualifiers: []
    }
  ...
  it 'returns the correct changed claims' do
    ...
    result = LargeBatchesAnalyzer.handle_large_batches([1_880_197_464], 50)
    current_content = result[1_880_197_464][:current_content]
    parent_content = result[1_880_197_464][:parent_content]
