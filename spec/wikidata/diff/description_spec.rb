...
RSpec.describe '.isolate_descriptions_differences' do
  ...
  it 'returns the correct added descriptions' do
    result = LargeBatchesAnalyzer.handle_large_batches([1_670_943_384], 50)
    current_content = result[1_670_943_384][:current_content]
    parent_content = result[1_670_943_384][:parent_content]
