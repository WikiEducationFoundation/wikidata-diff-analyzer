...
RSpec.describe '.isolate_aliases_differences' do
  ...
  it 'returns the correct added aliases' do
    result = LargeBatchesAnalyzer.handle_large_batches([1_900_774_614], 50)
    current_content = result[1_900_774_614][:current_content]
    parent_content = result[1_900_774_614][:parent_content]
