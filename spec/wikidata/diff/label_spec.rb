...
RSpec.describe '.isolate_labels_differences' do
  ...
  it 'returns the correct added labels' do
    result = LargeBatchesAnalyzer.handle_large_batches([670_856_707], 50)
    current_content = result[670_856_707][:current_content]
    parent_content = result[670_856_707][:parent_content]
